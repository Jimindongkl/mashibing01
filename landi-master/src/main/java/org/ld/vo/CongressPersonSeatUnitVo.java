...
public class CongressPersonSeatUnitVo implements Serializable{

	
	private static final long serialVersionUID = -6080882570679703408L;
	//人员id
	...
	public String toString() {
		return "CongressPersonSeatUnitVo [congressPersonId=" + congressPersonId + ", seatUnitId=" + seatUnitId
				+ ", rowId=" + rowId + ", columnId=" + columnId + ", seatArea=" + seatArea + ", id=" + id + ", num="
				+ num + ", name=" + name + ", status=" + status + ", staffGroupID=" + staffGroupID + ", staffGroupName="
